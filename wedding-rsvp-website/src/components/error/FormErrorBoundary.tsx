...
export function FormErrorBoundary({ children, onReset }: FormErrorBoundaryProps) {
  ...
  const renderFormErrorFallback = (error: Error, errorInfo: React.ErrorInfo, retry: () => void) => (
    <Card className="p-6 text-center border-red-200 bg-red-50">
      ...
      {/* Error Title */}
      <h3 className="text-base font-serif text-gray-800 mb-2">
        Form Error
      </h3>

      {/* Error Message */}
      <p className="text-gray-600 mb-4 text-sm">
        There was a problem with the form. Please try again or refresh the page.
      </p>
  ...
  return (
    <ErrorBoundary
      fallback={renderFormErrorFallback}
