  ...
  ({ className, label, error, helperText, ...props }, ref) => {
    ...
    return (
      <div className="space-y-2 animate-fade-in">
        ...
        <textarea
          className={cn(
            'flex min-h-[120px] w-full rounded-lg border-2 border-primary-200 dark:border-primary-800 bg-white dark:bg-stone-900 px-4 py-3 text-base dark:text-stone-100',
