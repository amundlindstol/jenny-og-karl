        ...
        <div className="max-w-2xl mx-auto">
          ...
          <Card className="p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
                ...
                <div className="space-y-2">
                  {attendingGuests.map((guest, index) => (
                    <div key={index} className="bg-green-50 dark:bg-green-900/20 p-3 rounded-md">
                      <p className="font-medium text-gray-800 dark:text-gray-100 text-sm sm:text-base">{guest.name}</p>
                ...
                <div className="space-y-2">
                  {notAttendingGuests.map((guest, index) => (
                    <div key={index} className="bg-gray-50 dark:bg-gray-800/50 p-3 rounded-md">
                      <p className="font-medium text-gray-600 dark:text-gray-300 text-sm sm:text-base">{guest.name}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {rsvpData.personalMessage && (
              <div className="mb-4 sm:mb-6">
                <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-2 sm:mb-3">Your Message</h3>
                <div className="bg-blue-50 dark:bg-blue-900/20 p-3 sm:p-4 rounded-md">
                  <p className="text-gray-700 dark:text-gray-300 italic text-sm sm:text-base">"{rsvpData.personalMessage}"</p>
                </div>
              </div>
            )}
          ...
          <Card className="p-4 sm:p-6 mb-6 sm:mb-8">
            <h3 className="text-base sm:text-lg font-semibold text-gray-800 dark:text-white mb-3 sm:mb-4">What's Next?</h3>
            <div className="space-y-2 sm:space-y-3 text-gray-600 dark:text-gray-400 text-sm sm:text-base">
              ...
              <p>• For questions, contact us at{' '}
                <a href="mailto:sarah.michael.wedding@email.com" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 underline break-all">
          ...
          <div className="mt-8 sm:mt-12 text-center text-gray-600 dark:text-gray-400">
            <h4 className="font-semibold mb-2 text-sm sm:text-base dark:text-white">Save the Date</h4>
