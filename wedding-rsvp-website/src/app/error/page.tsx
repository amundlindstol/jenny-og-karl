    ...
    switch (errorType) {
      case "invalid_code":
        return {
          ...
          message:
            "Invitasjonskoden du skrev inn er ikke gyldig. Vennligst sjekk bryllupsinvitasjonen din og prøv igjen.",
          icon: (
            <svg
          ...
          actions: [
            ...
            },
            {
              label: "Kontakt oss",
              action: () =>
                (window.location.href = `mailto:${text.contactEmail}`),
              primary: false,
            },
          ],
        };
      ...
      case "submission_failed":
        return {
          ...
          message:
            "Vi klarte ikke å lagre RSVP-svaret ditt. Vennligst prøv å sende inn igjen.",
          icon: (
            <svg
              className="w-8 h-8 text-red-600"
              fill="none"
      ...
      case "network_error":
        return {
          ...
          message:
            "Vi har problemer med å koble til våre servere. Vennligst sjekk internettforbindelsen din og prøv igjen.",
          icon: (
            <svg
              className="w-8 h-8 text-red-600"
              fill="none"
      ...
      case "duplicate_submission":
        return {
          ...
          message:
            "En RSVP har allerede blitt sendt inn for denne invitasjonskoden. Hvis du trenger å gjøre endringer, vennligst kontakt oss.",
          icon: (
            <svg
      ...
      default:
        return {
          ...
          message:
            errorMessage ||
            "En uventet feil oppstod. Vennligst prøv igjen eller kontakt oss for hjelp.",
          icon: (
            <svg
              className="w-8 h-8 text-red-600"
              fill="none"
